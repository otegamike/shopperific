...
export const addNewDevice = ( oldRefreshTokenArr: RefreshTokenEntry[], newRefreshTokenObj: RefreshTokenEntry )=> {

    let refreshTokenArray = oldRefreshTokenArr;
    const { deviceId } = newRefreshTokenObj;

    console.log("Adding device with ID:", deviceId, refreshTokenArray);
